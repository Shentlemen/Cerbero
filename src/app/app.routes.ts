...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'config-tickets', loadComponent: () => import('./config-tickets/config-tickets.component').then(m => m.ConfigTicketsComponent) },
      { path: 'bandejas-reclamos', redirectTo: 'config-tickets', pathMatch: 'full' },
